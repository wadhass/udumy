...
const Hero = () => {
  return (
    <div className="flex items-center justify-center flex-col w-full
        ...
        Empowre your future with the courses designed to <span 
        ...
        <p className="md:block hidden text-gray-500 max-w-2xl mx-auto">
            We bring together world-class instructors, content and a supportive
            community to help you scheive your personal and professional goals.
        </p>
        <p className="md:hidden text-gray-500 max-w-sm mx-auto">
        We bring together world-class instructors, content and a supportive
        community to help you scheive your personal and professional goals.</p>
        <SearchBar />
    </div>
  )
}
