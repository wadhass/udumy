...
const AddCourse = () => {
  ...
  const [lectureDetails, setLecturesDetails] = useState(
    {
      lectureTitle: '',
      lectureDuration: '',
      lectureUrl: '',
    ...
    setChapters(
      chapters.map((chapter) => {
        if (chapter.chapterId === currentChapterId){
          const newLecture = {
            ...lectureDetails,
            lectureOder: chapter.chapterContent.length > 0 ? chapter.chapterContent.slice(-1)[0]
            .lectureOder + 1 : 1,
            lectureId: uniqid()
          };
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex items-center justify-between flex-wrap'>
              <div className='flex flex-col gap-1'>
                <p>Course Price</p>
                <input onChange={e => setCoursesPrice(e.target.value)} value={coursePrice} 
                ...
                <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
                  ...
                  {!chapter.collapsed && (
                    <div className='p-4'>
                      {chapter.chapterContent.map((lecture, lectureIndex) => (
                        <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                          <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration}
                            mins - <a href={lecture.lectureUrl} target='_blank' className='text-blue-500'>
                              Link
                            </a>
                      ...
                      cursor-pointer mt-2' onClick={() => handleLecture('add', chapter.chapterId)}>
                        + Add Lecture</div>
                    </div>
                  )}
                </div>
                  ...
                  <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                    ...
                    <div className='mb-2'>
                      ...
                      <input
                       ...
                       onChange={(e) => setLecturesDetails({...lectureDetails,lectureTitle:
                        e.target.value
                       })}
                       />
                    </div>
                    ...
                    <div className='mb-2'>
                      ...
                      <input
                       ...
                       onChange={(e) => setLecturesDetails({ ...lectureDetails,lectureDuration:
                        e.target.value
                       })}
                       />
                    </div>
                    ...
                    <div className='mb-2'>
                      ...
                      <input
                       ...
                       onChange={(e) => setLecturesDetails({...lectureDetails,lectureUrl:
                        e.target.value
                       })}
                       />
                    </div>
                    ...
                    <div className='flex gap-2 my-4'>
                      ...
                      <input
                       ...
                       onChange={(e) => setLecturesDetails({...lectureDetails,isPreviewFree:
                        e.target.checked })}                     
                       />
                    </div>
